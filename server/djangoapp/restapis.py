...
def analyze_review_sentiments(text):
    url = "https://api.us-east.natural-language-understanding.watson.cloud.ibm.com/instances/df6e84eb-f679-4a48-802b-0891b6b5f7bb"
    api_key = "zwCEzR68KoojnJtUu04EWbA5Svvd08AYgyVJHWBNg8DE"
...
def get_dealer_reviews_from_cf(url, **kwargs):
    ...
    if json_result:
        ...
        for dealer_review in reviews:
            ...
            label = analyze_review_sentiments(review_obj.review)
            dealer_review["label"] = label
    return reviews
